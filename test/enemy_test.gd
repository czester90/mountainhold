...
func test_default_stats() -> void:
	...
	assert_bool(e.behavior_tags.has("wall_assault")).is_true()
	assert_int(e.level).is_equal(1)
	assert_float(e.defense).is_equal(1.0)
	assert_float(e.armor).is_equal(0.05)
	assert_float(e.get("_wall_target_refresh")).is_equal(0.42)
	assert_float(e.get("_ladder_search_refresh")).is_equal(0.55)
...
func test_ladder_orc_stats_and_group() -> void:
	...
	assert_bool(e.behavior_tags.has("ladder_carrier")).is_true()
	assert_float(e.get("_ladder_search_refresh")).is_equal(0.45)
